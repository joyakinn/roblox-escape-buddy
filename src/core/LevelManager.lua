...
function LevelManager:CreateAllLevels()
	...
	levels[16] = {
		...
		buddyCount = 1,
		enemies = {"Buddy"},
		objectives = {"Survive the flower field"},
		rewards = 200,
		nextLevel = 17,
		hasCheckpoint = true,
		specialMechanics = {
	...
	levels[17] = {
		...
		buddyCount = 1,
		enemies = {"Buddy"},
		objectives = {"Find shelter from petals"},
		rewards = 180,
		nextLevel = 18,
		hasCheckpoint = false,
		specialMechanics = {
	...
	levels[18] = {
		...
		buddyCount = 1,
		enemies = {"Buddy"},
		objectives = {"Find the exit before it closes"},
		rewards = 210,
		nextLevel = 19,
		hasCheckpoint = false,
		specialMechanics = {
	...
	levels[19] = {
		...
		buddyCount = 1,
		enemies = {"Buddy"},
		objectives = {"Silence Buddy's whispers"},
		rewards = 190,
		nextLevel = 20,
		hasCheckpoint = true,
		specialMechanics = {
	...
	levels[20] = {
		...
		buddyCount = 1,
		enemies = {"Buddy"},
		objectives = {"Find lights or escape"},
		rewards = 205,
		nextLevel = 21,
		hasCheckpoint = false,
		specialMechanics = {
	...
	levels[21] = {
		...
		buddyCount = 1,
		enemies = {"Buddy"},
		objectives = {"Cross the petal bridge"},
		rewards = 195,
		nextLevel = 22,
		hasCheckpoint = true,
		specialMechanics = {
	...
	levels[22] = {
		...
		buddyCount = 1,
		enemies = {"Buddy"},
		objectives = {"Piece together the memory"},
		rewards = 215,
		nextLevel = 23,
		hasCheckpoint = false,
		specialMechanics = {
	...
	levels[23] = {
		...
		objectives = {"Wake up from the dream"},
		rewards = 230,
		nextLevel = 24,
		hasCheckpoint = true,
		specialMechanics = {
	...
	levels[24] = {
		...
		buddyCount = 2,
		enemies = {"Buddy", "Puppet"},
		objectives = {"Reach the center and escape"},
		rewards = 220,
		nextLevel = 25,
		hasCheckpoint = false,
		specialMechanics = {
	...
	levels[29] = {
		...
		buddyCount = 2,
		enemies = {"Buddy", "Puppet"},
		objectives = {"Escape Buddy's lair"},
		rewards = 250,
		nextLevel = 30,
		hasCheckpoint = true,
		specialMechanics = {
	...
	levels[31] = {
		...
		objectives = {"Escape the Trickster"},
		rewards = 280,
		nextLevel = 32,
		hasCheckpoint = true,
		specialMechanics = {
	...
	levels[32] = {
		...
		buddyCount = 2,
		enemies = {"Trickster", "Puppet"},
		objectives = {"Cross all platforms"},
		rewards = 270,
		nextLevel = 33,
		hasCheckpoint = false,
		specialMechanics = {
	...
	levels[34] = {
		...
		buddyCount = 2,
		enemies = {"Trickster", "Puppet"},
		objectives = {"Get to the other side"},
		rewards = 285,
		nextLevel = 35,
		hasCheckpoint = true,
		specialMechanics = {
	...
	levels[37] = {
		...
		buddyCount = 2,
		enemies = {"Trickster", "Puppet"},
		objectives = {"Survive the gauntlet"},
		rewards = 295,
		nextLevel = 38,
		hasCheckpoint = true,
		specialMechanics = {
	...
	levels[38] = {
		...
		buddyCount = 2,
		enemies = {"Trickster", "Puppet"},
		objectives = {"Survive the complete gauntlet"},
		rewards = 305,
		nextLevel = 39,
		hasCheckpoint = true,
		specialMechanics = {
	...
	levels[41] = {
		...
		objectives = {"Get deep into the forest"},
		rewards = 330,
		nextLevel = 42,
		hasCheckpoint = true,
		specialMechanics = {
	...
	levels[45] = {
		...
		buddyCount = 3,
		enemies = {"Buddy", "Puppet", "Trickster"},
		objectives = {"Reach the river end"},
		rewards = 350,
		nextLevel = 46,
		hasCheckpoint = false,
		specialMechanics = {
	...
	levels[49] = {
		...
		buddyCount = 3,
		enemies = {"Buddy", "Puppet", "Trickster"},
		objectives = {"Reach the forest edge"},
		rewards = 375,
		nextLevel = 50,
		hasCheckpoint = true,
		specialMechanics = {
